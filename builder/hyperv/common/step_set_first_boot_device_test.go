...
var parseIdentifierTests = [...]parseBootDeviceIdentifierTest{
	{1, "IDE", "IDE", 0, 0, false, false, true},
	{1, "idE", "IDE", 0, 0, false, false, true},
	{1, "CD", "CD", 0, 0, false, false, true},
	{1, "cD", "CD", 0, 0, false, false, true},
	{1, "DVD", "CD", 0, 0, false, false, true},
	{1, "Dvd", "CD", 0, 0, false, false, true},
	{1, "FLOPPY", "FLOPPY", 0, 0, false, false, true},
	{1, "FloppY", "FLOPPY", 0, 0, false, false, true},
	{1, "NET", "NET", 0, 0, false, false, true},
	{1, "net", "NET", 0, 0, false, false, true},
	{1, "", "", 0, 0, true, false, true},
	{1, "bad", "", 0, 0, true, true, true},
	{1, "IDE:0:0", "", 0, 0, true, true, true},
	{1, "SCSI:0:0", "", 0, 0, true, true, true},
	{2, "IDE", "", 0, 0, true, true, true},
	{2, "idE", "", 0, 0, true, true, true},
	{2, "CD", "CD", 0, 0, false, false, true},
	{2, "cD", "CD", 0, 0, false, false, true},
	{2, "DVD", "CD", 0, 0, false, false, true},
	{2, "Dvd", "CD", 0, 0, false, false, true},
	{2, "FLOPPY", "", 0, 0, true, true, true},
	{2, "FloppY", "", 0, 0, true, true, true},
	{2, "NET", "NET", 0, 0, false, false, true},
	{2, "net", "NET", 0, 0, false, false, true},
	{2, "", "", 0, 0, true, false, true},
	{2, "bad", "", 0, 0, true, false, true},
	{2, "IDE:0:0", "IDE", 0, 0, false, false, true},
	{2, "SCSI:0:0", "SCSI", 0, 0, false, false, true},
	{2, "Ide:0:0", "IDE", 0, 0, false, false, true},
	{2, "sCsI:0:0", "SCSI", 0, 0, false, false, true},
	{2, "IDEscsi:0:0", "", 0, 0, true, true, true},
	{2, "SCSIide:0:0", "", 0, 0, true, true, true},
	{2, "IDE:0", "", 0, 0, true, true, true},
	{2, "SCSI:0", "", 0, 0, true, true, true},
	{2, "IDE:0:a", "", 0, 0, true, true, true},
	{2, "SCSI:0:a", "", 0, 0, true, true, true},
	{2, "IDE:0:653", "", 0, 0, true, true, true},
	{2, "SCSI:-10:0", "", 0, 0, true, true, true},
}
